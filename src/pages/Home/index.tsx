  ...
  return (
    <div className={styles.home}>
      ...
      <div className={styles.main}>
        ...
        {(!suggestions.length && !isLoading) && <div className={styles.items_empty}>
          <svg width="102" height="108">
            <g fill="none" opacity="0.5">
              ...
              <path
                fill="#3A4374"
                d="M0 44.902l97.429-21.645-19.167-5.612S67.881.37 65.11.01c-2.772-.361-53.131 10.42-53.131 10.42L8.785 34.77 0 44.902zm20.284 58.601L9.272 86.027l48.14-8.265 3.305 16.746 4.888-15.424 24.628 4.882-5.007 19.537z"
              ></path>
              <path
                fill="#FFF"
              ...
              <path
                fill="#3A4374"
                d="M86.352 84.471A2.519 2.519 0 0183.87 82.3l-2.292-16.634a.4.4 0 01.343-.45l4.432-.617a.398.398 0 01.296.08.38.38 0 01.151.265l2.276 16.626a2.508 2.508 0 01-.479 1.868 2.49 2.49 0 01-1.66.97l-.256.04a2.474 2.474 0 01-.328.024zm-3.929-18.518l2.236 16.234c.132.936.991 1.59 1.925 1.467h.263a1.714 1.714 0 001.454-1.932l-2.236-16.234-3.642.465z"
              ></path>
              <path
                fill="#FFF"
